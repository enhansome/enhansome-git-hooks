...
* [Husky](https://github.com/typicode/husky) ⭐ 35,330 | 🐛 107 | 🌐 JavaScript | 📅 2026-03-19 - Git hooks made easy.
* [pre-commit](https://github.com/pre-commit/pre-commit) ⭐ 15,593 | 🐛 25 | 🌐 Python | 📅 2026-08-17 - A framework for managing and maintaining multi-language pre-commit hooks.
* [Lefthook](https://github.com/Arkweid/lefthook) ⭐ 8,848 | 🐛 89 | 🌐 Go | 📅 2026-09-24 - Fast and powerful Git hooks manager for any type of projects.
...
* [Lolcommits](https://github.com/mroth/lolcommits) ⭐ 4,820 | 🐛 40 | 🌐 Ruby | 📅 2026-09-14 - Takes a snapshot with your webcam every time you git commit code, and archives a lolcat style image with it.
