...
* [Husky](https://github.com/typicode/husky) ⭐ 35,332 | 🐛 107 | 🌐 JavaScript | 📅 2026-03-19 - Git hooks made easy.
* [pre-commit](https://github.com/pre-commit/pre-commit) ⭐ 15,594 | 🐛 25 | 🌐 Python | 📅 2026-08-17 - A framework for managing and maintaining multi-language pre-commit hooks.
* [Lefthook](https://github.com/Arkweid/lefthook) ⭐ 8,852 | 🐛 90 | 🌐 Go | 📅 2026-09-24 - Fast and powerful Git hooks manager for any type of projects.
