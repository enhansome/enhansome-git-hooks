...
* [Husky](https://github.com/typicode/husky) ⭐ 35,273 | 🐛 108 | 🌐 JavaScript | 📅 2026-03-19 - Git hooks made easy.
* [pre-commit](https://github.com/pre-commit/pre-commit) ⭐ 15,507 | 🐛 26 | 🌐 Python | 📅 2026-08-10 - A framework for managing and maintaining multi-language pre-commit hooks.
* [Lefthook](https://github.com/Arkweid/lefthook) ⭐ 8,650 | 🐛 89 | 🌐 Go | 📅 2026-08-03 - Fast and powerful Git hooks manager for any type of projects.
